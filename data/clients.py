"""Mock client data for the XP AAI platform."""
...
MOCK_CLIENTS = [
    ...
    {
        "id": "cli_007",
        "name": "Albert da Silva",
        "email": "albert.silva@email.com",
        "phone": "(11) 93210-9876",
...
# Portfolio holdings for each client
MOCK_HOLDINGS = {
    "cli_001": {
        "holdings": [
...
# Transactions for February 2026
MOCK_TRANSACTIONS = {
    "cli_001": [
    ...
    "cli_007": [],  # Albert - no recent transactions, needs review
}
...
COMMUNICATION_LOG = [
    ...
    {"clientId": "cli_007", "date": "2026-02-15", "type": "email", "subject": "Revisão de carteira - posições em queda", "status": "sent"},
]
